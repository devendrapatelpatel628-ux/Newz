...
class AddProxiesRequest(BaseModel):
    ...
    validate_proxies: bool = Field(default=True, alias="validate", description="Validate proxies before adding")
...
@app.get("/")
async def root():
    """Service info or Railway-hosted frontend."""
...
# ==================== Python-only Web Frontend ====================

from web_only_ui import register_python_only_frontend

register_python_only_frontend(app, globals())
